...
describe "AbstractNode (via Block)" do
  describe "#add_role" do
    it "adds a new role" do
      ...
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"role" => "lead"})
  ...
  describe "#enabled_options" do
    it "returns the set of enabled options" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"autoplay-option" => "", "interactive-option" => ""})
  ...
  describe "#has_role?" do
    it "returns true when role is present" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"role" => "lead center"})
  ...
  describe "#option?" do
    it "returns true when option is set" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"interactive-option" => ""})
  ...
  describe "#reftext" do
    it "returns the reftext attribute" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"reftext" => "My Reference"})
  ...
  describe "#set_attr" do
    ...
    it "overwrites existing attribute by default" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"role" => "old"})
