...
describe Asciicrystal::Cli::Options do
  describe "initialization" do
    it "should have default values" do
      opts = Asciicrystal::Cli::Options.new
      ...
      opts.safe_mode.should eq(Asciicrystal::SafeMode::UNSAFE)
