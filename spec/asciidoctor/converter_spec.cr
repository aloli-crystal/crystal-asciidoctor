...
class CustomHtmlConverterA < Asciicrystal::Converter::Base
  def convert(node : Asciicrystal::AbstractNode, transform : String? = nil) : String
    "document"
  end
end

class CustomTextConverterA < Asciicrystal::Converter::Base
  def convert(node : Asciicrystal::AbstractNode, transform : String? = nil) : String
    "document"
  end
end

class CustomConverterForRegistration < Asciicrystal::Converter::Base
  def convert(node : Asciicrystal::AbstractNode, transform : String? = nil) : String
    "custom content"
  end
end

class CustomConverterForRegistration2 < Asciicrystal::Converter::Base
  def convert(node : Asciicrystal::AbstractNode, transform : String? = nil) : String
    "custom content 2"
  end
end
...
describe Asciicrystal::Converter do
  describe "BackendTraits" do
    it "should derive backend traits for html5 backend" do
      traits = Asciicrystal::Converter::Base.derive_backend_traits("html5")
    ...
    it "should derive backend traits for docbook5 backend" do
      traits = Asciicrystal::Converter::Base.derive_backend_traits("docbook5")
    ...
    it "should derive backend traits for unknown backend" do
      traits = Asciicrystal::Converter::Base.derive_backend_traits("dita2")
    ...
    it "should derive backend traits with explicit basebackend" do
      traits = Asciicrystal::Converter::Base.derive_backend_traits("slides", "html")
      traits.basebackend.should eq("html")
      traits.filetype.should eq("html")
      traits.outfilesuffix.should eq(".html")
      traits.htmlsyntax.should eq("html")
  ...
  describe "DefaultRegistry" do
    it "should have built-in html5 converter registered" do
      Asciicrystal::Converter::DefaultRegistry.converter_for("html5").should eq(Asciicrystal::Converter::Html5Converter)
    end

    it "should have built-in docbook5 converter registered" do
      Asciicrystal::Converter::DefaultRegistry.converter_for("docbook5").should eq(Asciicrystal::Converter::DocBook5Converter)
    end

    it "should have built-in manpage converter registered" do
      Asciicrystal::Converter::DefaultRegistry.converter_for("manpage").should eq(Asciicrystal::Converter::ManPageConverter)
    end

    it "should return nil for unregistered backend" do
      Asciicrystal::Converter::DefaultRegistry.converter_for("nonexistent").should be_nil
    end

    it "should create an instance of a registered converter" do
      converter = Asciicrystal::Converter::DefaultRegistry.create("html5")
      converter.should_not be_nil
      converter.should be_a(Asciicrystal::Converter::Html5Converter)
    end

    it "should return nil when creating instance for unregistered backend" do
      Asciicrystal::Converter::DefaultRegistry.create("nonexistent").should be_nil
    end

    it "should register and retrieve a custom converter" do
      begin
        Asciicrystal::Converter::DefaultRegistry.register(CustomConverterForRegistration, "test-backend-1")
        Asciicrystal::Converter::DefaultRegistry.converter_for("test-backend-1").should eq(CustomConverterForRegistration)
      ensure
        Asciicrystal::Converter::DefaultRegistry.unregister_all
      end
    end

    it "should register a converter for multiple backends" do
      begin
        Asciicrystal::Converter::DefaultRegistry.register(CustomConverterForRegistration, "test-backend-2a", "test-backend-2b")
        Asciicrystal::Converter::DefaultRegistry.converter_for("test-backend-2a").should eq(CustomConverterForRegistration)
        Asciicrystal::Converter::DefaultRegistry.converter_for("test-backend-2b").should eq(CustomConverterForRegistration)
      ensure
        Asciicrystal::Converter::DefaultRegistry.unregister_all
      end
    end
    ...
    it "should unregister all custom converters but keep built-in ones" do
      begin
        Asciicrystal::Converter::DefaultRegistry.register(CustomConverterForRegistration, "test-backend-3")
        Asciicrystal::Converter::DefaultRegistry.converter_for("test-backend-3").should eq(CustomConverterForRegistration)
        Asciicrystal::Converter::DefaultRegistry.unregister_all
        Asciicrystal::Converter::DefaultRegistry.converter_for("test-backend-3").should be_nil
        Asciicrystal::Converter::DefaultRegistry.converter_for("html5").should eq(Asciicrystal::Converter::Html5Converter)
      ensure
        Asciicrystal::Converter::DefaultRegistry.unregister_all
      end
    ...
    it "should list all registered converters" do
      converters = Asciicrystal::Converter::DefaultRegistry.converters
      converters.should be_a(Hash(String, Asciicrystal::Converter::Base.class))
  ...
  describe "CustomFactory" do
    it "should create a custom factory with seed registry" do
      factory = Asciicrystal::Converter::CustomFactory.new({"custom-be" => CustomConverterForRegistration})
    ...
    it "should return nil for unregistered backend in custom factory" do
      factory = Asciicrystal::Converter::CustomFactory.new
    ...
    it "should list all converters in custom factory" do
      factory = Asciicrystal::Converter::CustomFactory.new({"be1" => CustomConverterForRegistration, "be2" => CustomConverterForRegistration2})
  ...
  describe "CompositeConverter" do
    it "should delegate to first converter that handles the transform" do
      html5 = Asciicrystal::Converter::Html5Converter.new("html5")
      composite = Asciicrystal::Converter::CompositeConverter.new("html5", [html5] of Asciicrystal::Converter::Base)
    ...
    it "should raise if no converter handles the transform" do
      template = Asciicrystal::Converter::TemplateConverter.new("html5")
      composite = Asciicrystal::Converter::CompositeConverter.new("html5", [template] of Asciicrystal::Converter::Base)
    ...
    it "should use backend traits from source converter if provided" do
      html5 = Asciicrystal::Converter::Html5Converter.new("html5")
      composite = Asciicrystal::Converter::CompositeConverter.new("html5", [html5] of Asciicrystal::Converter::Base, html5)
  ...
  describe "TemplateConverter" do
    it "should initialize with empty templates" do
      converter = Asciicrystal::Converter::TemplateConverter.new("html5")
