...
describe "Blocks" do
  ...
  describe "Comments" do
    ...
    pending "should not render adjacent line comment between paragraphs" do
    ...
    pending "should not render adjacent comment block between paragraphs" do
    ...
    pending "comment style on paragraph should only skip paragraph" do
  ...
  describe "Quote and Verse Blocks" do
    ...
    pending "should render quote block with attribution" do
    ...
    pending "should render quote block with complex content" do
    ...
    pending "should render markdown-style quote block with single paragraph and no attribution" do
    ...
    pending "should render lazy markdown-style quote block" do
      # TODO: markdown-style quote blocks not yet implemented
      input = "> A famous quote.\nSome more inspiring words."
      output = convert_string(input)
      output.should contain("quoteblock")
    ...
    pending "should render markdown-style quote block with multiple paragraphs" do
      # TODO: markdown-style quote blocks not yet implemented
      input = "> A famous quote.\n>\n> Some more inspiring words."
      output = convert_string(input)
      output.should contain("quoteblock")
    ...
    pending "should render markdown-style quote block with attribution" do
      # TODO: markdown-style quote blocks not yet implemented
    ...
    pending "should render markdown-style quote block with only attribution" do
      # TODO: markdown-style quote blocks not yet implemented
      input = "> -- Anonymous"
      output = convert_string(input)
      output.should contain("quoteblock")
    ...
    pending "should render quoted paragraph-style quote block with attribution" do
    ...
    pending "should render single-line verse block with attribution" do
  ...
  describe "Admonition Blocks" do
    ...
    pending "can override caption of admonition block using document attribute" do
    ...
    pending "blank caption document attribute should not blank admonition block caption" do
  ...
  describe "Preformatted Blocks" do
    pending "should separate adjacent paragraphs and listing into blocks" do
    ...
    pending "should not crash when converting verbatim block that has no lines" do
    ...
    pending "should preserve newlines in literal block" do
    ...
    pending "should preserve newlines in listing block" do
    ...
    pending "should preserve guard in front of callout if icons are not enabled" do
  ...
  describe "Metadata" do
    ...
    pending "empty block anchor should not appear in output" do
  ...
  # =========================================================================
  describe "Images" do
    pending "can convert block image with alt text defined in macro" do
    ...
    pending "converts SVG image using img element by default" do
    ...
    pending "can convert block image with alt text defined in block attribute above macro" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "alt text in macro overrides alt text above macro" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "should substitute attribute references in alt text defined in image block macro" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "should set direction CSS class on image if float attribute is set" do
      # TODO: image block macro not yet fully rendering
      input = "[float=left]\nimage::images/tiger.png[Tiger]"
      output = convert_string_to_embedded(input)
      output.should contain("imageblock")
    ...
    pending "should set text alignment CSS class on image if align attribute is set" do
      # TODO: image block macro not yet fully rendering
      input = "[align=center]\nimage::images/tiger.png[Tiger]"
      output = convert_string_to_embedded(input)
      output.should contain("imageblock")
    ...
    pending "should pass through image that references uri" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "can resolve image relative to imagesdir" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "should render block image with title" do
      # TODO: image block macro not yet fully rendering
      input = ".A Tiger\nimage::images/tiger.png[Tiger]"
      output = convert_string_to_embedded(input)
      output.should contain("imageblock")
    ...
    pending "should render block image with link" do
      # TODO: image block macro not yet fully rendering
    ...
    pending "should render block image with dimensions" do
      # TODO: image block macro not yet fully rendering
  ...
  describe "Media" do
    ...
    pending "should detect and convert video macro with positional attributes for poster and dimensions" do
    ...
    pending "should set direction CSS class on video block if float attribute is set" do
    ...
    pending "should set text alignment CSS class on video block if align attribute is set" do
    ...
    pending "video macro should honor all options" do
    ...
    pending "video macro should add time range anchor with start time if start attribute is set" do
    ...
    pending "video macro should add time range anchor with end time if end attribute is set" do
      # TODO: video time range not yet implemented
    ...
    pending "video macro should add time range anchor with start and end time" do
      # TODO: video time range not yet implemented
    ...
    pending "video macro should use imagesdir attribute to resolve target and poster" do
    ...
    pending "video macro should not use imagesdir attribute to resolve target if target is a URL" do
    ...
    pending "video macro should output custom HTML with iframe for vimeo service" do
    ...
    pending "video macro should output custom HTML with iframe for youtube service" do
    ...
    pending "audio macro should resolve relative to imagesdir" do
  ...
  describe "Source code" do
    pending "should support fenced code block using backticks" do
    ...
    pending "should not recognize fenced code blocks with more than three delimiters" do
    ...
    pending "should support fenced code blocks with languages" do
    ...
    pending "should support fenced code blocks with languages and numbering" do
    ...
    pending "listing block without an explicit style and with a second positional argument should be promoted to a source block" do
  ...
  describe "Abstract and Part Intro" do
    pending "should make abstract on open block without title a quote block for article" do
    ...
    pending "should allow abstract in document with title if doctype is book" do
