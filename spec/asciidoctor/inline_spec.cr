...
describe Asciicrystal::Inline do
  describe "#initialize" do
    ...
    it "creates an inline node with type and target" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, "text", type: :xref, target: "#section")
  ...
  describe "#block?" do
    it "returns false" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor)
  ...
  describe "#content" do
    it "returns the text" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, "Hello")
  ...
  describe "#reftext?" do
    it "returns true for ref type with text" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, "ref text", type: :ref)
    ...
    it "returns true for bibref type with text" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, "bib text", type: :bibref)
      inline.reftext?.should be_true
    end
    ...
    it "returns false for xref type" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, "xref text", type: :xref)
    ...
    it "returns false when text is nil" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      inline = Asciicrystal::Inline.new(block, :anchor, nil, type: :ref)
      inline.reftext?.should be_false
    end
  end
end
