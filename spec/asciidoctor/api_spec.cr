...
describe Asciidoctor do
  ...
  describe ".convert" do
    ...
    pending "should load input file from filename" do
      sample_input_path = "sample.adoc"
      File.write(sample_input_path, "= Document Title")
    ...
    pending "should accept attributes as array" do
    ...
    pending "should accept attributes as string" do
      doc = Asciidoctor.load("text", {"toc" => "", "sectnums" => "", "source-highlighter" => "coderay", "idprefix" => "", "idseparator" => "-"})
      doc.attributes.should be_a(Hash(String, String))
      doc.attr?("toc").should be_truthy
      doc.attr("toc").should eq("")
    ...
    pending "should convert source document to standalone document string when to_file is false and standalone is true" do
      sample_input_path = "sample.adoc"
      File.write(sample_input_path, "= Document Title\n\ncontent")
    ...
    pending "should convert source document to standalone document string when to_file is false and header_footer is true" do
      sample_input_path = "sample.adoc"
      File.write(sample_input_path, "= Document Title\n\ncontent")
    ...
    pending "should accept attributes as array for convert" do
      sample_input_path = "sample.adoc"
    ...
    pending "should accept attributes as string for convert" do
      sample_input_path = "sample.adoc"
      File.write(sample_input_path, "== Section A")
      output = Asciidoctor.convert_file(sample_input_path, {"sectnums" => "", "idprefix" => "", "idseparator" => "-", "to_file" => "false"})
      output.should contain("id=\"section-a\"")
