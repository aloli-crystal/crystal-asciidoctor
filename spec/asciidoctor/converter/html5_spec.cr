...
describe Asciicrystal::Converter::Html5Converter do
  ...
  describe "#initialize" do
    ...
    it "creates an XHTML converter" do
      c = Asciicrystal::Converter::Html5Converter.new(htmlsyntax: "xml")
  ...
  describe "#convert_section" do
    it "converts a level 1 section" do
      doc = Asciicrystal::Document.new
      section = Asciicrystal::Section.new(doc, level: 1)
      section.id = "sect1"
    ...
    it "converts a level 0 section (part)" do
      doc = Asciicrystal::Document.new
      section = Asciicrystal::Section.new(doc, level: 0)
      section.id = "part1"
  ...
  describe "#convert_admonition" do
    it "converts an admonition block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :admonition)
  ...
  describe "#convert_literal" do
    it "converts a literal block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :literal)
  ...
  describe "#convert_example" do
    it "converts an example block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :example)
  ...
  describe "#convert_sidebar" do
    it "converts a sidebar block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :sidebar)
  ...
  describe "#convert_quote" do
    it "converts a quote block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :quote)
  ...
  describe "#convert_verse" do
    it "converts a verse block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :verse)
  ...
  describe "#convert_open" do
    it "converts an open block" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :open)
  ...
  describe "#convert_ulist" do
    it "converts an unordered list" do
      ...
      item1 = Asciicrystal::ListItem.new(list, "First item")
      item2 = Asciicrystal::ListItem.new(list, "Second item")
      list.items << item1
      list.items << item2
  ...
  describe "#convert_olist" do
    it "converts an ordered list" do
      doc = Asciicrystal::Document.new
      list = Asciicrystal::List.new(doc, :olist)
      item1 = Asciicrystal::ListItem.new(list, "Step one")
      item2 = Asciicrystal::ListItem.new(list, "Step two")
      list.items << item1
      list.items << item2
  ...
  describe "#convert_page_break" do
    it "converts a page break" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :page_break)
  ...
  describe "#convert_thematic_break" do
    it "converts a thematic break" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :thematic_break)
  ...
  describe "#convert_inline_quoted" do
    it "converts strong text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "bold text", type: :strong)
    ...
    it "converts emphasis text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "italic text", type: :emphasis)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts monospaced text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "code", type: :monospaced)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts marked text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "highlighted", type: :mark)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts superscript text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "2", type: :superscript)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts subscript text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "2", type: :subscript)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts double-quoted text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "quoted", type: :double)
      result = converter.convert_inline_quoted(inline)
    ...
    it "converts single-quoted text" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "quoted", type: :single)
      result = converter.convert_inline_quoted(inline)
      result.should eq "&#8216;quoted&#8217;"
    end
    ...
    it "adds role as class to tagged inline" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :quoted, "bold", type: :strong)
  ...
  describe "#convert_inline_anchor" do
    it "converts a link" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :anchor, "Example", type: :link, target: "https://example.com")
    ...
    it "converts a xref" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :anchor, "See section", type: :xref, target: "#section1")
      result = converter.convert_inline_anchor(inline)
    ...
    it "converts a ref (anchor)" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :anchor, "", type: :ref)
      inline.id = "myref"
      result = converter.convert_inline_anchor(inline)
    ...
    it "converts a bibref" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :anchor, nil, type: :bibref)
      inline.id = "ref1"
      result = converter.convert_inline_anchor(inline)
  ...
  describe "#convert_inline_break" do
    it "converts an inline break" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :break, "text")
  ...
  describe "#convert_inline_button" do
    it "converts an inline button" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :button, "OK")
  ...
  describe "#convert_inline_kbd" do
    it "converts a single key" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :kbd, "")
  ...
  describe "#convert_inline_indexterm" do
    it "returns empty string for invisible indexterm" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :indexterm, "hidden", type: :invisible)
    ...
    it "returns text for visible indexterm" do
      doc = Asciicrystal::Document.new
      inline = Asciicrystal::Inline.new(doc, :indexterm, "visible", type: :visible)
      result = converter.convert_inline_indexterm(inline)
