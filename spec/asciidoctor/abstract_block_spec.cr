...
describe "AbstractBlock (via Block)" do
  describe "#<<" do
    it "appends a child block" do
      ...
      parent = Asciicrystal::Block.new(doc, :open, content_model: Asciicrystal::ContentModel::Compound)
      child = Asciicrystal::Block.new(doc, :paragraph, source: "Hello")
      parent << child
  ...
  describe "#alt" do
    it "returns the alt attribute" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :image, attributes: {"alt" => "A photo"})
  ...
  describe "#blocks?" do
    ...
    it "returns true when child blocks exist" do
      doc = Asciicrystal::Document.new
      parent = Asciicrystal::Block.new(doc, :open, content_model: Asciicrystal::ContentModel::Compound)
      parent << Asciicrystal::Block.new(doc, :paragraph)
  ...
  describe "#find_by" do
    it "finds blocks by context" do
      ...
      doc << section
      para1 = Asciicrystal::Block.new(doc, :paragraph)
      section << para1
      para2 = Asciicrystal::Block.new(doc, :paragraph)
      section << para2
      listing = Asciicrystal::Block.new(doc, :listing)
      section << listing
    ...
    it "finds nested blocks" do
      ...
      section = Asciicrystal::Section.new(doc)
      doc << section
      para = Asciicrystal::Block.new(doc, :paragraph)
      section << para
      nested_section = Asciicrystal::Section.new(doc, parent: section, level: 2)
      section << nested_section
      nested_para = Asciicrystal::Block.new(doc, :paragraph)
  ...
  describe "#source_location" do
    it "can be set and retrieved" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph)
      loc = Asciicrystal::SourceLocation.new("test.adoc", 42)
  ...
  describe "#xreftext" do
    it "returns reftext when set" do
      doc = Asciicrystal::Document.new
      block = Asciicrystal::Block.new(doc, :paragraph, attributes: {"reftext" => "See here"})
