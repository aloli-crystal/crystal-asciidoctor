...
describe Asciicrystal::SourceLocation do
  describe "#initialize" do
    ...
    it "creates a source location with nil file" do
      loc = Asciicrystal::SourceLocation.new(nil, 1)
  ...
  describe "#advance" do
    it "advances the line number by 1 by default" do
      loc = Asciicrystal::SourceLocation.new("test.adoc", 10)
      loc.advance
  ...
  describe "#dup" do
    it "returns a copy of the source location" do
      loc = Asciicrystal::SourceLocation.new("test.adoc", 42, "/dir", "path")
      copy = loc.dup
  ...
  describe "#to_s" do
    ...
    it "formats with only line number when file is nil" do
      loc = Asciicrystal::SourceLocation.new(nil, 42)
